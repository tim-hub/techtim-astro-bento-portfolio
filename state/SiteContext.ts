...
export const INTRO: IIntroContext = {
  ...
  dx: [
    ...
    '🔨 UX was out by Donald Norman in mid 1990s, and becoming popular in 2000s with the rise of mobile devices. However DX was not out until late 2010s, and it is still not popular. ',
    ...
    '⬆️ DXI is the process of improving DX, and it is a very important part of the product development process, which is the area I am passionate about. ',
  ]
}
